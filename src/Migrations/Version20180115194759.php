 ...
 */
class Version20180115194759 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE mark (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, coordinate_x NUMERIC(6, 2) NOT NULL, coordinate_y NUMERIC(6, 2) NOT NULL, image VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE museum (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, website VARCHAR(50) NOT NULL, address VARCHAR(100) NOT NULL, phone_number VARCHAR(20) NOT NULL, facebook VARCHAR(50) NOT NULL, twitter VARCHAR(50) NOT NULL, instagram VARCHAR(50) NOT NULL, youtube VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE route (id INT AUTO_INCREMENT NOT NULL, museum_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, duration TIME NOT NULL, category VARCHAR(50) NOT NULL, INDEX IDX_2C420794B52E5B5 (museum_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
