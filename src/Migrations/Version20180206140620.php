 ...
 */
class Version20180206140620 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE mark (id INT AUTO_INCREMENT NOT NULL, media_id INT DEFAULT NULL, museum_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, coordinate_x NUMERIC(6, 4) NOT NULL, coordinate_y NUMERIC(6, 4) NOT NULL, image VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_6674F2715E237E06 (name), UNIQUE INDEX UNIQ_6674F271EA9FDD75 (media_id), INDEX IDX_6674F2714B52E5B5 (museum_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE media (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, file VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_6A2CA10C5E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE museum (id INT AUTO_INCREMENT NOT NULL, admin_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, website VARCHAR(50) NOT NULL, address VARCHAR(100) NOT NULL, phone_number VARCHAR(20) NOT NULL, facebook VARCHAR(50) NOT NULL, twitter VARCHAR(50) NOT NULL, instagram VARCHAR(50) NOT NULL, youtube VARCHAR(50) NOT NULL, map VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_624744775E237E06 (name), UNIQUE INDEX UNIQ_62474477642B8210 (admin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
