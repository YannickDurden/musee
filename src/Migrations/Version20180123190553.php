 ...
 */
class Version20180123190553 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE route (id INT AUTO_INCREMENT NOT NULL, museum_id INT DEFAULT NULL, description LONGTEXT NOT NULL, name VARCHAR(100) NOT NULL, duration TIME NOT NULL, INDEX IDX_2C420794B52E5B5 (museum_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
